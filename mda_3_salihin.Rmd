...
```{r}
# Creating the histogram of GDP per capita (e_migdppc) across different regions (e_regionpol_6C), but factorising region!
vdem_2015 %>% 
  mutate(e_regionpol_6C = recode(e_regionpol_6C, '1' = "E. Europe & C. Asia", '2' = "L. Am & Carib", '3' = "M.E. & N. Africa", '4' = "S.S. Africa", '5' = "W. Eu & N. Am", '6' = "Asia & Pacific")) %>%
  mutate(e_regionpol_6C = (fct_infreq(e_regionpol_6C)))
  ggplot(aes(e_migdppc)) +
  geom_histogram() +
  theme_minimal() +
  labs(title = "Distribution of GDP per capita (2015) for Democratic countries", x = "GDP per capita", y = "Count") +
