...
<!-------------------------- Start your work below ---------------------------->
```{r}
#### SCRAP AND REDO BELOW:
# I will have to create a facet-wrapped graph of GDP per capita for countries based on region!
...
vdem_2015 %>% 
  mutate(e_boix_regime = recode(e_boix_regime, '0' = "Non-democracies", '1' = "Democracies")) %>%
